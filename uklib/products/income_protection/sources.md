...
- Publisher: LV= (document names Liverpool Victoria Friendly Society Limited as
  provider — older entity; see research-file Gaps)
...
- URL: https://www.lifequote.co.uk/cdrom/KFDocsProps/Liverpool%20Victoria/Liverpool%20Victoria%20IP%20KFD.pdf
  (intermediary-hosted mirror of the LV= document; original lvadviser.com copy
  returns 403)
- Retrieved: YES (curl, full text extracted)
...
- Publisher: Exeter Friendly Society Limited (trading as The Exeter; register no.
  205309; Friendly Societies Act 1992 reg. 91F)
...
- Publisher: Exeter Friendly Society Limited
- Doc type: adviser product guide, 20 pp. 2019 edition — records the adviser-sold
...
- Doc type: plan provisions (full T&Cs for the Personal Protection Plan menu — Life,
  Serious Illness and Income Protection Cover), 159 pp. Edition 02/2025
...
- Doc type: registered contract rules (the legal terms; the KFD S11 is the
  plain-English guide to this document), 28 pp.
...
- Retrieved: YES (landing page fetched and read). CMIR 12 title/date per
...
- Retrieved: NO in the product research pass (the handbook site is
...
- Retrieved: NO in the product research pass. fetched_ok = false here; both
  standards were fetched and verified in the shared library — facts are cited via
  [REG-R33] and [REG-R34]
...
|---|---|---|
| REG-R1 | PRA Rulebook — Technical Provisions Part (same Part as [R7] above) | fetched (browser) |
| REG-R2 | PRA Rulebook — Matching Adjustment Part (same Part as [R8] above) | fetched (browser) |
| REG-R4 | Insurance and Reinsurance Undertakings (Prudential Requirements) (Risk Margin) Regulations 2023 (SI 2023/1346) | fetched |
| REG-R11 | FCA Handbook ICOBS (ICOBS 1.1 read; same sourcebook as [R9] above) | fetched (browser) |
| REG-R12 | FCA Handbook PRIN 2A — The Consumer Duty | fetched (browser; PRIN 2A.1 read) |
| REG-R14 | FSMA 2000 (Regulated Activities) Order 2001, Sch. 1 Pt II (same SI as [R6] above) | fetched |
| REG-R17 | Finance Act 2012, Part 2 — Insurance companies carrying on long-term business | fetched |
...
| REG-R24 | CMI "92" Series tables (AM92/AF92 family page) | fetched |
...
| REG-R33 | FRC TAS 100: General Actuarial Standards, v2.0 | fetched (FRC page; PDF not read) |
...
originals are bot-blocked or superseded; document codes recorded for
