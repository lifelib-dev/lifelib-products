...
Access-date note: the research file's per-entry access dates, originally recorded as
"undefined", have been corrected to 2026-08-03, matching its header statement that all
successful fetches were performed on 2026-08-03; that date is used below.

---

## Primary product and firm documents [S#]

(uklib-with_profits-s1)=
...
- Accessed 2026-08-03. Retrieved: YES (PDF fetched; text extracted with pypdf)

(uklib-with_profits-s2)=
...
- Accessed 2026-08-03. Retrieved: YES (direct WebFetch returned HTTP 403; successfully downloaded with a browser user-agent and text-extracted)

(uklib-with_profits-s6)=
...
- Accessed 2026-08-03. Retrieved: YES (downloaded and text-extracted)

(uklib-with_profits-s7)=
...
## Regulatory and actuarial references [R#]

(uklib-with_profits-r1)=
...
- Accessed 2026-08-03. Retrieved: YES (full chapter text read via browser; site serves a JS shell to plain fetches)

(uklib-with_profits-r2)=
...
- Accessed 2026-08-03. Retrieved: YES (full text via browser)

(uklib-with_profits-r3)=
...
- Accessed 2026-08-03. Retrieved: YES (full text via browser; plain fetch returns 403)

(uklib-with_profits-r7)=
...
- Accessed 2026-08-03. Retrieved: YES (TAS 200 page; the general actuarial-standards landing URL tried first returned 404)

(uklib-with_profits-r12)=
...
- Accessed 2026-08-03. Retrieved: YES (PDF fetched and text-extracted)

(uklib-with_profits-r13)=
...
- Accessed 2026-08-03. Retrieved: YES (page fetched; the canonical papers it lists — Needleman & Roff 1995; Hibbert & Turnbull 2003; Hare et al. 2000; O'Brien 2012 — were **not** themselves fetched; cited via this page only)
...
- **REG-R2** — PRA Rulebook: Matching Adjustment Part (with-profits guaranteed annuity elements as MA "eligible element"). https://www.prarulebook.co.uk/pra-rules/matching-adjustment (fetched_ok: yes)
- **REG-R3** — PRA Rulebook: Transitional Measure on Technical Provisions Part. https://www.prarulebook.co.uk/pra-rules/transitional-measure-on-technical-provisions/31-12-2024 (fetched_ok: yes)
- **REG-R4** — Insurance and Reinsurance Undertakings (Prudential Requirements) (Risk Margin) Regulations 2023 (SI 2023/1346). https://www.legislation.gov.uk/uksi/2023/1346/made (fetched_ok: yes)
- **REG-R12** — FCA Handbook PRIN 2A — The Consumer Duty. https://handbook.fca.org.uk/handbook/PRIN/2A/1.html (fetched_ok: yes)
- **REG-R15** — ITTOIA 2005, Part 4 Chapter 9 — Gains from contracts for life insurance etc. (chargeable event gains; 5% allowance). https://www.legislation.gov.uk/ukpga/2005/5/part/4/chapter/9 (fetched_ok: yes)
- **REG-R16** — HMRC Insurance Policyholder Taxation Manual (IPTM). https://www.gov.uk/hmrc-internal-manuals/insurance-policyholder-taxation-manual (fetched_ok: yes, landing/contents)
- **REG-R17** — Finance Act 2012, Part 2 — Insurance companies carrying on long-term business (BLAGAB, I-E). https://www.legislation.gov.uk/ukpga/2012/14/part/2 (fetched_ok: yes)
- **REG-R18** — HMRC Life Assurance Manual (LAM). https://www.gov.uk/hmrc-internal-manuals/life-assurance (fetched_ok: yes, landing/contents)
- **REG-R22** — Continuous Mortality Investigation — main page (role and subscriber access model). https://www.actuaries.org.uk/learn-and-develop/continuous-mortality-investigation (fetched_ok: yes)
- **REG-R24** — CMI "92" Series tables (AM92/AF92 family). https://www.actuaries.org.uk/learn-and-develop/continuous-mortality-investigation/cmi-mortality-and-morbidity-tables/92-series-tables (fetched_ok: yes)
- **REG-R30** — CMI Mortality Projections Model CMI_2025 (announcement, with Working Paper 211). https://actuaries.org.uk/news-and-media-releases/news-articles/2026/mar/10-mar-26-cmi-model-shows-further-rise-in-cohort-life-expectancy/ (fetched_ok: yes)
- **REG-R32** — ONS National life tables (UK series, 2021–2023). https://www.ons.gov.uk/peoplepopulationandcommunity/birthsdeathsandmarriages/lifeexpectancies/bulletins/nationallifetablesunitedkingdom/2021to2023 (fetched_ok: yes)
- **REG-R33** — FRC Technical Actuarial Standard TAS 100: General Actuarial Standards, v2.0. https://www.frc.org.uk/library/standards-codes-policy/actuarial/tas-100/ (fetched_ok: yes, standard's FRC page)
- **REG-R38** — UK Endorsement Board — IFRS 17 Insurance Contracts (UK adoption). https://www.endorsement-board.uk/projects/ifrs-17-insurance-contracts/ (fetched_ok: yes)
