...
drafting. All citations accessed 2026-08-03 (the research file's individual entries
record retrieval as of 03/08/2026; its global access-date field was left unset).
...
- URL: https://www.legalandgeneral.com/media/adviser/annuities/document-library/key-features/w12325.pdf
...
- Doc type: Policy conditions (terms and conditions booklet), 20 pp.
- URL: https://www.legalandgeneral.com/asset/497ae6/globalassets/adviser/annuities/document-library/terms-and-conditions/da2440.pdf/
- Retrieved: YES (PDF downloaded, full text extracted). Document code DA2440 04/26.
- Used for: the contractual mechanics anchor — payment timing, escalation (incl. RPI
...
- URL: https://www.wearejust.co.uk/globalassets/just-retirement/documents/1001-pension-annuity-kfd.pdf
...
- Doc type: Policy conditions, 12 pp.
- URL: https://www.wearejust.co.uk/globalassets/just-retirement/documents/729-terms-of-the-just-retirement-pension-annuity.pdf
- Retrieved: YES (PDF downloaded, full text extracted).
- Used for: escalation variants (pure RPI, 0-floor, LPI 5/2.5 with windows), payment
...
- URL: https://p3.aprimocdn.net/canadalifeuk/canretire-lifetime-annuity-enhanced-lifetime-annuity-and-scheme-pension-key-features.pdf
...
- Doc type: Policy conditions (policy provisions), 10 pp.
- URL: https://p3.aprimocdn.net/canadalifeuk/lifetime-annuity-policy-provisions.pdf
- Retrieved: YES (PDF downloaded, full text extracted). Code 8259 – 0626RC.
...
- Doc type: Key Features Document + policy conditions (single combined PDF, 22 pp.)
- URL: https://pensionaccess.co.uk/wp-content/uploads/2023/02/Aviva-01.10.2020.pdf
- Retrieved: YES (PDF downloaded, full text extracted). NOTE: 2019/2020 vintage
  retrieved via a third-party mirror because Aviva's own host blocks automated
  fetches (see S10, S11). Tax references predate the 2024 LSA/LSDBA regime.
...
- URL: https://static.aviva.io/content/dam/document-library/adviser/annuity/an15036c.pdf
...
- URL: https://static.aviva.io/content/dam/document-library/adviser/annuity/an15037c.pdf
- Retrieved: NO — not retrieved (same host as S10 returns HTTP 403 to automated
  fetches). Known reference only; the 02/2020 edition of the same document is covered
  by S9. (Cited in the Variations vintage caveat only.)
...
- Retrieved: YES (rulebook text as at 07/02/2025, viewed 03/08/2026; rules dated 30/06/2024 and 31/12/2024).
- Used for: MA permission requirement and eligibility conditions (no future premiums,
...
- URL: https://www.handbook.fca.org.uk/handbook/COBS/19/9.html
- Retrieved: YES (full rule text as of 03/08/2026; section last updated 02/04/2024).
...
- Publisher: legislation.gov.uk
- URL: https://www.legislation.gov.uk/ukpga/2004/12/schedule/28
- Retrieved: YES.
...
- Publisher: IFoA / CMI
- URL: https://www.actuaries.org.uk/learn-and-develop/continuous-mortality-investigation/cmi-working-papers/mortality-projections/cmi-working-paper-201
- Retrieved: YES (abstract page; model software restricted).
...
- Retrieved: YES.
- Used for: professional-standards scope (v2.0 published 20 September 2024, effective
  1 January 2025).
...
- **REG-R1** — PRA Rulebook, Technical Provisions Part (best estimate + risk margin definition).
- **REG-R2** — PRA Rulebook, Matching Adjustment Part (effective 30 June 2024; MA permission, eligible elements).
- **REG-R3** — PRA Rulebook, Transitional Measure on Technical Provisions Part (TMTP; legacy back-books).
- **REG-R4** — Insurance and Reinsurance Undertakings (Prudential Requirements) (Risk Margin) Regulations 2023, SI 2023/1346 (4% cost of capital; λ = 0.9 life, floor 0.25).
- **REG-R5** — PRA PS10/24, Review of Solvency II: Reform of the Matching Adjustment (published 6 June 2024).
- **REG-R8** — PRA SS7/18, Solvency II: Matching adjustment (current version October 2025; matching tests and MA practice).
- **REG-R17** — Finance Act 2012, Part 2 (pension business is non-BLAGAB, trade-profit basis).
- **REG-R22** — CMI main page (access model: current tables and Projections Model restricted to Authorised Users).
- **REG-R27** — CMI briefing note, final "16" Series pension annuity in payment tables (PMA16/PFA16, 2015–2018 experience).
- **REG-R30** — CMI Mortality Projections Model CMI_2025 announcement with WP211 (published March 2026; calibrated to E&W data to 31 December 2025).
- **REG-R33** — FRC TAS 100: General Actuarial Standards v2.0 (effective 1 July 2023).
- **REG-R36** — IFoA Proxy Modelling Working Party, BAJ vol. 29 (2024) (proxy layer over heavy annuity cash-flow models).
- **REG-R38** — UK Endorsement Board, IFRS 17 UK adoption (adopted 16 May 2022, effective 1 January 2023).
