...
```{eval-rst}
.. automodule:: uslib.products.immediate_annuity.SPIA_US_S
```

## `Projection`

```{eval-rst}
.. automodule:: uslib.products.immediate_annuity.SPIA_US_S.Projection
   :members:
```
...
```{eval-rst}
.. automodule:: uslib.products.immediate_annuity.SPIA_US_S.Data
   :members:
```
