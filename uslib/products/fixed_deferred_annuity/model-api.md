...
```{eval-rst}
.. automodule:: uslib.products.fixed_deferred_annuity.MYGA_US_S
```

## `Projection`

```{eval-rst}
.. automodule:: uslib.products.fixed_deferred_annuity.MYGA_US_S.Projection
   :members:
```
...
```{eval-rst}
.. automodule:: uslib.products.fixed_deferred_annuity.MYGA_US_S.Data
   :members:
```
