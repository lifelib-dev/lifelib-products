...
```{eval-rst}
.. automodule:: uslib.products.deferred_income_annuity.DIA_US_S
```

## `Projection`

```{eval-rst}
.. automodule:: uslib.products.deferred_income_annuity.DIA_US_S.Projection
   :members:
```
...
```{eval-rst}
.. automodule:: uslib.products.deferred_income_annuity.DIA_US_S.Data
   :members:
```
