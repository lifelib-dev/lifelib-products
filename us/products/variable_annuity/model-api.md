...
```{eval-rst}
.. automodule:: uslib.products.variable_annuity.VA_US_S
```

## `Projection`

```{eval-rst}
.. automodule:: uslib.products.variable_annuity.VA_US_S.Projection
   :members:
```
...
```{eval-rst}
.. automodule:: uslib.products.variable_annuity.VA_US_S.Data
   :members:
```
