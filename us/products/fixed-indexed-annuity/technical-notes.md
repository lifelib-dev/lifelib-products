...
`us/references/regulatory-and-actuarial-references.md`, whose shared **R1–R72** numbering spans
...
- **Formulaic statutory (CARVM).** **AG 33** constructs and values the integrated benefit streams
  ...
  statement about their mechanics is [unverified].
...
- **Asset adequacy.** ASOP No. 22 — the standard AG 35's requirement runs through, meaning the
  same projection must serve CARVM and cash flow testing [REG-R29][REG-R27].
