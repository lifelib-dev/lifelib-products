...
All REG-R# entries accessed 2026-08-03 per the bibliography file.
...
`us/_research/regulatory-actuarial.md`. The two documents in this directory cite only facts
recorded in those research files; **[std]** items are standardizations introduced at drafting
and are attributed to no source.
