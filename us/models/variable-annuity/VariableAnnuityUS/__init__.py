...
:mod:`~VariableAnnuityUS` is the executable counterpart of
...
:mod:`FixedDeferredAnnuityUS`, and the naming, the Data/Projection split and the
...
:mod:`~VariableAnnuityUS.Projection`
    ...
    Reference, which resolves to the single :mod:`~VariableAnnuityUS.Data` Space.
...
months 3, 6, 9, ... **[std]**. Note the contrast with :mod:`TermLifeUS`, where ``t``
