...
:mod:`~VariableAnnuityUS.Projection` as ``data``. :mod:`~VariableAnnuityUS.Projection`
...
``us/models/variable-annuity/``, rather than data stored inside the model. The model
