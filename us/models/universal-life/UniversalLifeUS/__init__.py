...
:mod:`~UniversalLifeUS` is the executable counterpart of
...
* The grace and lapse-for-insufficiency cascade. The trigger and the required cure
  ...
  :func:`~UniversalLifeUS.Projection.is_shortfall` and
  :func:`~UniversalLifeUS.Projection.cure_premium_pp`, but the notes leave the
  ...
  **This absence bites on a shipped model point.** Point 2 enters shortfall in policy
  ...
  death benefit: :func:`~UniversalLifeUS.Projection.av_pp_db_basis` floors it at zero
...
* MEC status has no cash flow consequence for the insurer, so
  :func:`~UniversalLifeUS.Projection.is_mec` flags and does not project. The flag does
