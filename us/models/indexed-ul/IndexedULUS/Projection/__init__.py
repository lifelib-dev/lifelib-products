...
"""The by-policy monthly projection of the :mod:`~IndexedULUS` model.
...
The readers live in the unparameterized :mod:`~IndexedULUS.Data` Space, reached here
...
Cells names follow :mod:`~UniversalLifeUS` -- the chassis these notes defer to -- and
