"""Run the FixedDeferredAnnuityUS reference model and print its cash flow statement.

    python us/models/fixed-deferred-annuity/run.py            # anchor cell (point_id = 1)
    python us/models/fixed-deferred-annuity/run.py 2          # another model point
...
model = mx.read_model(Path(__file__).parent / "FixedDeferredAnnuityUS")
