...
:mod:`~ImmediateAnnuityUS.Projection` as ``data``. :mod:`~ImmediateAnnuityUS.Projection`
...
``us/models/immediate-annuity/``, rather than data stored inside the model. The model
