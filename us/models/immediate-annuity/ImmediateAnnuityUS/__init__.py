...
:mod:`~ImmediateAnnuityUS` is the executable counterpart of
...
:mod:`~ImmediateAnnuityUS.Projection`
    ...
    ``data`` Reference, which resolves to the single :mod:`~ImmediateAnnuityUS.Data`
    Space.
...
:mod:`~ImmediateAnnuityUS.Projection`'s docstring and pinned by tests. A test asserts
