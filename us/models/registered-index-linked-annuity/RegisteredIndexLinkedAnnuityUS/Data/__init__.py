...
:mod:`~RegisteredIndexLinkedAnnuityUS.Projection` as ``data``.
:mod:`~RegisteredIndexLinkedAnnuityUS.Projection` is parameterized by ``point_id``, so
...
``us/models/registered-index-linked-annuity/``, rather than data stored inside the model.
