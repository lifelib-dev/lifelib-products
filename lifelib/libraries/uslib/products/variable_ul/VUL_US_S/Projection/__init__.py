...
LA_t                       la_pp(t)                        Loan-account collateral, EOM
LA_t (BOM)                 la_pp_at(t, "BEF_PREM")         Collateral, start of month
D_t                        loan_bal_pp(t)                  Outstanding policy debt, EOM
D_t (BOM)                  loan_bal_pp_at(t, "BEF_PREM")   Policy debt, start of month
