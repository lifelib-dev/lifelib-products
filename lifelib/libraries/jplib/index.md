...
and is derived, never indexed by. The same rule holds in every model of this library, annual
or monthly, and `tests/test_model_conventions_jp.py` asserts it for every model point.
